---
title: "Improved Solar Power Forecasting with Probabilistic Predictions"
...
This notebook provides an improved approach to forecasting Germany's hourly solar power generation for June 2025, addressing critical issues in the original analysis and adding probabilistic forecasting capabilities. Key improvements include:

- **Fixed data leakage** in validation strategy
- **Corrected solar position** calculations
- **Simplified model selection** focusing on the most effective approaches
- **Added probabilistic forecasting** with prediction intervals
- **Improved evaluation metrics** for uncertainty quantification
...
We implement physically accurate solar position calculations and simplified but effective feature engineering.
...
## 4. Improved Data Splitting Strategy
...
## 5. Baseline Model: Improved Persistence

```{python}
#| label: baseline-model
class ImprovedPersistenceModel:
    """
...
baseline_model = ImprovedPersistenceModel(decay_factor=365)
