...
# Load datasets
solar_q1 = pd.read_csv('germany_solar_observation_q1.csv', parse_dates=['DateTime'])
atm_q1 = pd.read_csv('germany_atm_features_q1.csv', parse_dates=['DateTime'])
demand_q2 = pd.read_csv('germany_electricity_demand_observation_q2.csv', parse_dates=['DateTime'])
atm_q2 = pd.read_csv('germany_atm_features_q2.csv', parse_dates=['DateTime'])
solar_q2 = pd.read_csv('germany_solar_observation_q2.csv', parse_dates=['DateTime'])
```
